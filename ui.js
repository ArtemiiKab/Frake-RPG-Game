...
dragEnd = function () {
	this.className = "img-items";
	if (isDropped) {
		document.querySelector('.headBox').append(this)
	}
...
var itemsInInventory = document.querySelectorAll('.img-items');
updateInventoryItems = function () {
	var isDropped = false;
	itemsInInventory = document.querySelectorAll('.img-items');
	const headBox = document.querySelector('.headBox');
	for (let item of itemsInInventory) {
		item.addEventListener('dragstart', dragStart);
		item.addEventListener('dragend', dragEnd);
		headBox.addEventListener("dragover", dragOver);
		headBox.addEventListener("dragenter", dragEnter);
		headBox.addEventListener("dragleave", dragLeave);
		headBox.addEventListener("drop", dragDrop)
