Npc = function(name, quest, id, x,y,width,height, img, hp, mana, AC, constitution, strength, dexterity, intellect, wisdom, bulletType){
...
generateNpc = function(x, y, name, quest){
    var height = 100     //between 10 and 40
    var width = 100
    var id = Math.random();
    var img = new Image();
    img.src = "./img/"+name+".png";
    Npc(name, quest, id, x, y, width, height, img, 200, 200, 10, 3, 3, 5, 7, 2, "fireball" )
